...
Route::group(['middleware' => 'auth:api', 'prefix' => 'v1'], function () {
	...
	Route::get('/getclient/{id}', 'API\QuotesController@getclient');
	...
	Route::put('/productupdate/{id}', 'API\ProductController@productupdate');
	...
	Route::apiResource('LoanPayment', 'API\LoanPaymentController');
	Route::post('/paymentinvoice/{id}', 'API\QuotesController@payment');
	Route::post('/loanpayment/{id}', 'API\LoanController@payment');
	...
	Route::get('/view_payment/{id}', 'API\PaymentsController@view_payment');
	Route::get('/view_loanpayment/{id}', 'API\LoanPaymentController@view_loanpayment');
	Route::get('/loan_report/{id}', 'API\LoanController@loan_report');

	

	Route::get('/viewid/{id}', 'API\QuotesController@viewid');
	

	Route::apiResource('Contributors', 'API\ContributorController');
	...
	Route::get('/autoCompleted', 'API\CommonController@autoCompleted');
	Route::get('/listTaxRate', 'API\CommonController@taxrate');
	Route::get('/category', 'API\CommonController@Category');
	Route::post('/statementdownload', 'API\ClientstatementController@statementdownload');

	

	Route::get('/Dashboardnew', 'API\DashboardController@Dashboardnew');
	Route::post('/saveExpense', 'API\CommonController@saveExpense');
	Route::get('/expenses', 'API\CommonController@expenses');
	Route::get('/showexpense/{id}', 'API\CommonController@showexpense');

	Route::put('/updateExpense/{id}', 'API\CommonController@updateExpense');
	Route::post('/statementTest', 'API\ClientstatementController@statementTest');
	...
	Route::get('reportdownload/{id}', 'API\ClientstatementController@reportdownload');
