   ...
   <form id="app" @submit.prevent="handleSubmit" >
      <section class="hero is-fullheight is-default is-bold drop-special ">
         ...
         <div class="container containeg breadcrums1">
            <h6 class="form-name is-uppercase is-pulled-left is-size-6">Add Purchase</h6>
            <div class="breadcrumb is-pulled-right" aria-label="breadcrumbs">
               ...
               <button class="button has-background-dark has-text-white is-size-7">
                  <router-link to="/frontoffice" class="has-text-white"> <i class="fas fa-backward icon1"></i> BACK
                  </router-link>
               </button>
                     ...
                     <div class="column">
                        <div class="card">
                           <header class="card-header">
                              <p class="card-header-title">Client Details</p>
...
<div class="columns is-mobile is-multiline ">
          <div class="column is-3 is-12-mobile">
            <p class="bd-notification is-info">
              ...
              <div class="field">
                <p class="control has-icons-left has-icons-right">
                  <input class="input" type="text" disabled id="client_name" name="client_name" maxlength="25" v-model="client.client_name"
                     placeholder=" Name">
                </p>
            ...
            <p class="bd-notification is-info">
              ...
              <div class="field">
                <p class="control has-icons-left has-icons-right">
                  <input class="input" type="text" id="email" disabled name="email" maxlength="100" v-model="client.email"
                     placeholder="Email">
                </p>
          ...
          <div class="column is-3 is-12-mobile">
            ...
            <p class="bd-notification is-info">
              <label>Phone Number <span class="has-text-danger	"></span>
              </label>
              <div class="field">
                <p class="control has-icons-left has-icons-right">
                  <input class="input" type="text" id="city" disabled name="city" max-length="20" v-model="client.phone_number"
                     placeholder="City">
                </p>
 ...
 <div class="column is-3 is-12-mobile">
            ...
            <p class="bd-notification is-info">
              ...
              <div class="field">
                <p class="control has-icons-left has-icons-right">
                  <input class="input" type="text" disabled id="state" name="state" v-model="client.status"
                     placeholder="State">
                </p>
                           ...
                           <div class="columns">
                                    ...
                                    <div class="field">
                                       <p class="control has-icons-left has-icons-right">
                                          <b-autocomplete id="product_name" name="product_name" v-model="el.product_name"
                                             field="title" @select="getPrice" :key="el.index" @typing="getAsyncData(index, arr.length)"
                                         ...
                                         <span  v-if="index == fff" v-show="errors.has('product_name')" class="invalid-feedback">{{"Productname is required"}}</span> 
                                    </div>
                              ...
                              <div class="column">
                                 <div class="bd-notification is-info">
                                    ...
                                    <div class="field">
                                       <p class="control has-icons-left has-icons-right">
                                          <input id="quantity" name="quantity" v-model="el.quantity" class="input" type="text" v-validate="`required|numeric|excluded:0|max_value:${quantitites[index]}`"
                                                          placeholder="Quantity" v-on:click="getAsyncDat(index)">
                                       </p>
                                      
                                    </div>
                                     <span   v-if="index == fff" v-show="errors.has('quantity')" class="invalid-feedback">{{ errors.first('quantity') }}</span>
                              ...
                              <div class="column">
                                 <div class="bd-notification is-info">
                                    ...
                                    <div class="field">
                                       <p class="control has-icons-left has-icons-right">
                                          <input id="'price" name="price" v-model="el.price" class="input" type="text"  v-validate="'required'"
                              ...
                              <div class="column ">
                                 <div class="bd-notification is-info">
                                    ...
                                    <div class="field">
                                       <p class="control has-icons-left has-icons-right">
                                          <input id="total" name="total" class="input" type="text"
                                             v-model="el.total" readonly  @input="calculatedFromAmount"/>
                                       </p>
                                    </div>
                                 </div>
                              </div>
               ...
               <div class="column">
                  ...
                  <div class="card section sectionadd is-clearfix form-quote">
                        ...
                        <div class="field">
                           <p class="control has-icons-left has-icons-right">
                              <input id="quote_no" name="quote_no" v-model="quoteform.quote_no"  v-validate="'required'"  @blur="getquote"
                                 class="input" type="text" placeholder="Plan">
                           </p>
                     ...
                     <div class="bd-notification is-info">
                        ...
                        <div class="field">
                           <p class="control has-icons-left has-icons-right">
                              <b-datepicker id="date" name="date" class="control has-icons-left has-icons-right" v-model="quoteform.date"  
                     ...
                     <div class="bd-notification is-info">
                        ...
                        <div class="field">
                           <p class="control has-icons-left has-icons-right">
                              <input id = "payment_plan" name="payment_plan" class="input" type="number" 
                                 v-model="quoteform.payment_plan"   v-validate="'required'"     >
                              
                           </p>
                           <span v-show="errors.has('payment_plan')" class="invalid-feedback">{{payment_plan_error}}</span>
...
<script>
     ...
     data() {
       return {
         ...
         client:
            ...
            arr: [
               { product_id: '', product_name: '', tax_rate_id: '', description: '', quantity: '', tax_rate_value: '', price: '', total: '' }],
            ...
            validdate: "date",
           valid_payment_plan: "Payment plan is required",
      ...
      created: function () {
         if( this.$route.query.edit.toString() == 'false')
            //this.editgetquotes();
             this.getquote();
      },
  ...
  //alert(10);
   ...
   //  },
     ...
     getquote() {
      ...
      this.quoteform.quote_no = 'BK'+Date.now().toString().substr(5, 7);
          ...
          axios.get(url,{ 
           ...
           product_name: this.arr[index].product_name 
             ...
             this.data = response.data.product;
               this.SelectedProduct_id = response.data.product_details;
               this.Selectedproduct_name = response.data.product
               this.allQuantities = response.data.filtergetQuantity
               this.SelectedQuantity = response.data.filtergetQuantity
               this.SelecetedDescription=	response.data.description
               this.SelecetedPrice = response.data.price
 ...
 console.log(this.selectedproduct)
      ...
      var productName =  this.arr[index].product_name
            
         var productNameIndex = this.Selectedproduct_name.indexOf(productName)

         var QuantityIndex = this.SelectedQuantity[productNameIndex]
             ...
             this.quantitites[index] = QuantityIndex;
            ...
            //   console.log(context.editMode)
               ...
               context.setLoading(true);
                  ...
                  for (let i = 0; i < context.arr.length; i++) {
                    ...
                    console.log(this.quoteform.date);
                  formdata.append('quote_no', context.quoteform.quote_no);
                  if (context.quoteform.date != '') {
                     var dateObj = new Date(context.quoteform.date);
                     var momentObj = moment(dateObj);
                     var momentString = momentObj.format('YYYY-MM-DD');
                     // context.quoteform.date = momentString;
                     formdata.append('date', momentString);
                  }

                  
  var monthly_payment  = context.wholetotal/context.quoteform.payment_plan

                  formdata.append('payment_plan', context.quoteform.payment_plan);
                  ...
                  formdata.append('wholetotal', context.wholetotal);
                   ...
                   formdata.append('monthly_payment', monthly_payment.toFixed());
                  ...
                  axios.post(url, formdata, config).then(response => {
                     ...
                     if (response.data.status == 1) {
                        ...
                        context.$router.push('/frontoffice');
                     } else {
                        context.$buefy.toast.open({
                           duration: 4000,
                           message: response.data.message,
      ...
      .finally(() => {
         ...
         getPrice(selected) {
               ...
               var product_id = this.SelectedProduct_id ;
                  product_id.forEach(function (value, index) {
                  
   
               });
               var product_name = this.Selectedproduct_name;
               ...
               this.selectedproduct[this.index] = this.Selectedproduct_name[productIndex]
               

               

               this.allQuantities = this.SelectedQuantity
               this.arr[this.index].description =this.SelecetedDescription[productIndex];
               this.arr[this.index].price = this.SelecetedPrice[productIndex];
               this.arr[this.index].product_id = this.SelectedProduct_id[productIndex];



                             var g = this.Selectedproduct_name[productIndex]
            
         var productNameIndex = this.Selectedproduct_name.indexOf(g)
         ...
         var QuantityIndex = this.SelectedQuantity[productNameIndex]
            ...
            this.quantitites[this.fff] = QuantityIndex;
  ...
  // console.log(this.arr)
         ...
         getclient() {
             this.setLoading(true);
            let url = '/getclient/' + this.$route.query.client_id;
            axios.get(url).then((response) => {
  ...
  deleteDropFile(index) {
         ...
         addCurrent(index) {
            if (this.arr[(this.arr.length)-1].product_name && this.arr[(this.arr.length)-1].quantity ) {     
      ...
      userState: state => state.user
        ...
        quotenoError(){
            ...
            if(this.quoteform.payment_plan == "")
            return this.valid_payment_plan
 ...
 wholeTotal(){
   ...
   //          var checkQuatity = (this.arr[i].quantity);
   //         }


         
   //            if( checkQuatity> this.quantitites){

   //  return this.quantityError = "quantity is larger"
   ...
   //         }
    ...
    for(let k=0;k < this.arr.length;k++){
      ...
      this.taxtot = (temp_taxtot).toFixed(3);
      this.subtotal = (temp_subtotal).toFixed(2);
      this.discount= (this.subtotal * this.quoteform.discountpercentage / 100);
