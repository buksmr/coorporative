<template>
        ...
        <div class="control is-flex">
          <b-switch v-model="isPaginated" class="is-size-7 is-uppercase">Paginated</b-switch>
                 ...
                 <div class="field has-addons is-pulled-right ">
                  ...
                  <router-link to="/loan" class="has-text-white"> <i class="fas fa-backward icon1"></i> BACK
                  </router-link>
               </button>
            </div>
 ...
 <b-table-column
          ...
          > {{props.row.currencies_id}}  {{ props.row.payment_amount}}</b-table-column>
 <b-table-column
        ...
        <a href=""><i class="fa fa-trash spaces has-text-grey-dark	" aria-hidden="true"></i> </a>
            ...
            <b-dropdown hoverable>
              ...
              <b-dropdown-item @click="goToDelete(props.row.payment_id)">
                <i class="fas fa-trash-alt icon1"></i> Reverse
              </b-dropdown-item>
      ...
      return this.data.filter(function(cust){
		...
		mounted: function()
		{
           ...
           if(this.$route.query.id != null && this.$route.query.id != ''){
                ...
                this.view_payment(this.$route.query.id );
      this.getpaymethod();
       this.callFunction(); 
